...
original_query = "what are the top 5 questions and answers of the 30 most confident answers by GPT-2?"
...
retriever = db.as_retriever(search_kwargs={"k": 3})  # Get more docs for better RRF
